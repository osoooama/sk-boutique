...
export default function InstagramFAB() {
  return (
    <a
      ...
      className="fixed bottom-20 md:bottom-24 left-4 md:left-6 z-50 w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 active:scale-90 min-touch-target group"
      style={{
