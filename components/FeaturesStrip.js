...
export default function FeaturesStrip({ isEnglish }) {
  const items = [
    ...
    {
      icon: "fa-certificate",
      title: isEnglish ? "EU Quality Certified" : "معتمدة من الاتحاد الأوروبي",
      desc: isEnglish ? "All pieces meet EU CE quality standards — European design, locally made" : "جميع القطع تخضع لمعايير CE الأوروبية — تصميم أوروبي، صناعة محلية"
    }
  ];
