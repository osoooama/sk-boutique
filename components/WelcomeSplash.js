      ...
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="space-y-2 flex flex-col items-center">
          ...
          <p className="text-sm text-[var(--text-muted)] font-light">
            {isEnglish
              ? "Modern luxury with authentic Jordanian spirit — weaving heritage with modernity"
              : "فخامة عصرية بأصالة أردنية — نخيط التراث بيد الحداثة"}
          </p>
        </div>
        ...
        <p className="text-xs text-[var(--text-dim)]">
          {isEnglish ? (
            <>Use code <span className="font-bold text-gold">NASHAMA</span> for 15% discount</>
          ) : (
            <>استخدم كود <span className="font-bold text-gold">NASHAMA</span> للحصول على خصم 15%</>
          )}
        </p>
      </div>
    </div>
