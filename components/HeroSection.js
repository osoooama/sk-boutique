...
export default function HeroSection({ isEnglish, onApplyPromo }) {
  const t = (key) => {
    const TRANSLATIONS = {
      ar: {
        heroBadge: "كل ما لدينا جميل",
        heroTitle1: "أناقة عصرية",
        heroTitle2: "بروح أردنية أصيلة",
        heroDesc: "تشكيلة حصرية تجمع الفخامة العالمية بأصالة الشماغ الأردني التراثي المهدّب — لكل نشمي ونشمية يعتز بهويته وتفرده.",
        heroExplore: "استكشف التشكيلة",
        heroStory: "قصتنا",
        promoCardTitle: "كل ما لدينا جميل",
        promoCardSubtitle: "تصاميم أردنية مميزة",
        promoCardDesc: "على جميع المعروضات والتصميمات في المتجر",
        promoCardClick: "انقر لتفعيل الخصم تلقائياً"
      },
      en: {
        heroBadge: "Everything we have is beautiful",
        heroTitle1: "Modern Elegance",
        heroTitle2: "With Authentic Jordanian Spirit",
        heroDesc: "An exclusive collection combining global luxury with the authenticity of the traditional fringed Jordanian Shemagh — for every Nashmi and Nashmia who cherishes their identity.",
        heroExplore: "Explore Collection",
        heroStory: "Our Story",
        promoCardTitle: "Everything is Beautiful",
        promoCardSubtitle: "Jordanian Designs",
        promoCardDesc: "On all items and designs in the store",
