...
export default function CatalogSection({
  ...
  const t = (key) => {
    const dict = {
      ar: {
        catalogBadge: "مجموعة النشامى الحصرية",
        catalogTitle: "تصاميمنا الراقية",
        catalogDesc: "موديلات عصرية مستوحاة من الهوية والتراث الأردني المهدّب — ارتدِ أصالتك بفخر وثقة.",
      ...
      en: {
        catalogBadge: "Exclusive Nashama Collection",
        catalogTitle: "Our Exquisite Designs",
        catalogDesc: "Modern styles inspired by the fringed Jordanian identity and heritage — wear your authenticity with pride.",
                ...
                >
                  <div className="relative aspect-[3/4] overflow-hidden bg-zinc-900 cursor-pointer">
                    ...
                    <button
                      ...
                      className={`absolute top-2.5 right-2.5 md:top-4 md:right-4 w-7.5 h-7.5 md:w-9 md:h-9 rounded-full flex items-center justify-center glass-effect transition duration-300 transform active:scale-90 ${
                  ...
                  <div className="p-3 md:p-5 space-y-1.5 md:space-y-2">
                    ...
                    <div className="flex items-center justify-between pt-0.5 md:pt-1">
                      ...
                      <button
                        ...
                        className="w-7.5 h-7.5 md:w-8 md:h-8 rounded-full bg-[var(--bg-subtle)] hover:bg-gold hover:text-black text-[var(--text-primary)]/80 transition-all duration-300 flex items-center justify-center active:scale-90"
