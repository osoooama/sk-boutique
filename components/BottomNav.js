...
export default function BottomNav({
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[var(--bg-tertiary)]/90 backdrop-blur-lg border-t border-[var(--border-subtle)] h-16 flex items-center justify-around px-4 pb-2">
